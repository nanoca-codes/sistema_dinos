  ...
  <div class="row gx-0 d-none d-lg-flex">
    <div class="col-lg-7 px-5 text-start">
      ...
      <div class="h-100 d-inline-flex align-items-center py-3">
        ...
        <small>Seg - Sex : 09.00 AM - 08.00 PM</small>
      </div>
    </div>
    ...
    >
      ...
      <div class="collapse navbar-collapse py-4 py-lg-0" id="navbarCollapse">
        <div class="navbar-nav ms-auto">
          ...
          <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu rounded-0 rounded-bottom m-0">
              <a href="animal.html" class="dropdown-item">Nossos Dinossauros</a>
              <a href="membership.html" class="dropdown-item">Planos</a>
              <a href="visiting.html" class="dropdown-item">Horas de visita</a>
        ...
        <a href="" class="btn" style="background-color: #cf1500; border-color: #cf1500; color: #ffffff;"
          >Compre seu ingresso!<i class="fa fa-arrow-right ms-3"></i
        ></a>
      </div>
    </nav>
    <!-- Navbar End -->
        ...
        <div class="col-lg-6 p-0 wow fadeIn" data-wow-delay="0.1s">
          ...
          >
            <h1 class="display-4 text-light mb-5">
              Venha viver uma aventura jurassica!
            </h1>
          <div class="d-flex align-items-center pt-4 animated slideInDown">
  <a href="" class="btn py-sm-3 px-3 px-sm-5 me-5" style="background-color: #cf1500; border-color: #cf1500; color: #ffffff;">
    Leia mais
  </a>
              <button
                type="button"
        ...
        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
          <div class="owl-carousel header-carousel">
            <div class="owl-carousel-item">
              <img class="img-fluid" src="img/dinossauro_1.jpg" alt="" />
            </div>
            <div class="owl-carousel-item">
              <img class="img-fluid" src="img/dinossauro_4.jpg" alt="" />
            </div>
            <div class="owl-carousel-item">
              <img class="img-fluid" src="img/dinossauro_3.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row g-5">
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h5 class="mb-3">
              <i class="far fa-check-circle text-primary me-3"></i>Os dinossauros mais incriveis que você vai conhecer!
            </h5>
            <a class="btn py-3 px-5 mt-3" style="color:#cf1500" href="">Leia mais</a>
          </div>
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="img-border">
              <img class="img-fluid" src="img/parque_1.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container py-5">
        <div class="row g-4">
          ...
          >
            ...
            <h1 class="text-white mb-2" data-toggle="counter-up">56324</h1>
        ...
        <div class="row g-5 mb-5 wow fadeInUp" data-wow-delay="0.1s">
          <div class="col-lg-6">
            ...
            <h1 class="display-5 mb-0">
              ...
              <span class="text-primary">para nossos vistantes</span> 
            </h1>
          </div>
          <div class="col-lg-6">
            <div
